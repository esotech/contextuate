...
2. **[Quickref Tool](../tools/quickref.tool.md)** - For generating AI-friendly references
...
Use the [Quickref Tool](../tools/quickref.tool.md) to generate AI-friendly references:
